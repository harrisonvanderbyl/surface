...
cpp -nostdinc -undef -x assembler-with-cpp -E ./sp12.dts -I./include/qcom -I./include/include > ./build/surface.dts
...
sudo cp ./build/x1e80100-microsoft-denali.dtb /boot/dtbs/6.16.0+/qcom/x1p42100-microsoft-sp12.dtb

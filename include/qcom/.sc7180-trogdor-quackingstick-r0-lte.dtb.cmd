savedcmd_arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dtb := gcc -E -Wp,-MMD,arch/arm64/boot/dts/qcom/.sc7180-trogdor-quackingstick-r0-lte.dtb.d.pre.tmp -nostdinc -I ./scripts/dtc/include-prefixes -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.sc7180-trogdor-quackingstick-r0-lte.dtb.dts.tmp arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dts ; ./scripts/dtc/dtc -o arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dtb -b 0 -iarch/arm64/boot/dts/qcom/ -i./scripts/dtc/include-prefixes -Wno-unique_unit_address -Wno-unit_address_vs_reg -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-simple_bus_reg   -d arch/arm64/boot/dts/qcom/.sc7180-trogdor-quackingstick-r0-lte.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.sc7180-trogdor-quackingstick-r0-lte.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.sc7180-trogdor-quackingstick-r0-lte.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.sc7180-trogdor-quackingstick-r0-lte.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.sc7180-trogdor-quackingstick-r0-lte.dtb.d 

source_arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dtb := arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dts

deps_arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dtb := \
...
arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dtb: $(deps_arch/arm64/boot/dts/qcom/sc7180-trogdor-quackingstick-r0-lte.dtb)

savedcmd_arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dtb := gcc -E -Wp,-MMD,arch/arm64/boot/dts/qcom/.sdm845-lg-judyp.dtb.d.pre.tmp -nostdinc -I ./scripts/dtc/include-prefixes -undef -D__DTS__ -x assembler-with-cpp -o arch/arm64/boot/dts/qcom/.sdm845-lg-judyp.dtb.dts.tmp arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dts ; ./scripts/dtc/dtc -o arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dtb -b 0 -iarch/arm64/boot/dts/qcom/ -i./scripts/dtc/include-prefixes -Wno-unique_unit_address -Wno-unit_address_vs_reg -Wno-avoid_unnecessary_addr_size -Wno-alias_paths -Wno-graph_child_address -Wno-simple_bus_reg   -d arch/arm64/boot/dts/qcom/.sdm845-lg-judyp.dtb.d.dtc.tmp arch/arm64/boot/dts/qcom/.sdm845-lg-judyp.dtb.dts.tmp ; cat arch/arm64/boot/dts/qcom/.sdm845-lg-judyp.dtb.d.pre.tmp arch/arm64/boot/dts/qcom/.sdm845-lg-judyp.dtb.d.dtc.tmp > arch/arm64/boot/dts/qcom/.sdm845-lg-judyp.dtb.d 

source_arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dtb := arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dts

deps_arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dtb := \
...
arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dtb: $(deps_arch/arm64/boot/dts/qcom/sdm845-lg-judyp.dtb)
